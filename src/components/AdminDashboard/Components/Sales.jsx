  ...
  return (
    <div className="w-full pl-52 ">
      <div className="h-screen">
        <div className="flex flex-wrap justify-between w-full gap-5 pr-10">
          {sales.map((item) => (
            <div className="w-[48%] flex justify-between h-52 gap-3" key={item}>
              ...
              <div className=" w-[60%] flex flex-col justify-around">
                ...
                <div>
                  <p className="mb-1 text-sm">ZAPATO TACON PUNTA REDONDA</p>
                ...
                <p className="w-full text-sm text-end">MXN $2,495</p>
              </div>
            </div>
          ))}
        </div>
