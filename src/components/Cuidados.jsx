        ...
        <>
            ...
            >
                ...
                <div className="px-11 py-5 flex flex-col gap-7">
                    ...
                    <div>
                        <p className="text-xs mb-4">Which Contains At Least:</p>
                        <p className="text-xs uppercase">OUTER SHELL</p>
                        <p className="text-xs">81% ALGODÓN DE CULTIVO ORGÁNICO CERTIFICADO OCS</p>
                    </div>
                    <div>
                        <p className="text-xs uppercase mb-4">CERTIFIED MATERIALS</p>
                        <p className="text-xs ">ALGODÓN DE CULTIVO ORGÁNICO CERTIFICADO OCS
                            Esta fibra se produce sin utilizar fertilizantes ni pesticidas artificiales y se cultiva a partir de semillas que no han sido modificadas genéticamente. Actualmente trabajamos con el Organic Content Standard (OCS) que supervisa el proceso desde el origen hasta el producto final.</p>
                    </div>
                    <div>
                        <p className="text-xs ">Certified By Intertek 193341.</p>
                        <p className="text-xs border-b inline-block">More Information</p>
                    </div>
