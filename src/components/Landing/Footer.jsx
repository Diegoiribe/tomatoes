...
const Footer = ({ color = 'white', bg = 'black' }) => {
  ...
  return (
    <div
      className="w-full overflow-hidden md:flex md:flex-row sm:flex-col md:h-screen md:px-20 sm:px-5 md:py-40 sm:py-20 black-section"
      style={{
        backgroundColor: bg,
        color: color
      }}
    >
      <div className="md:w-1/3 sm:w-full">
        <p className="overflow-hidden font-bold text-7xl">SPAZYO</p>
      </div>
